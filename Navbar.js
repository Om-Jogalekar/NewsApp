            ...
            <div>
                <nav className="navbar fixed-top navbar-expand-lg">
                    <div className="container-fluid">
                        <a className="navbar-brand" href="/"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlkXxBkvkOoDANHI-4fWK4ouxls9-Gi9yL-2iH0G8_NE1J9tuibp6PZUbedxCTNGUoyGQ&usqp=CAU" alt="" srcset="" width={50}/></a>
                        ...
                        <span className='navbar '>{this.props.date}</span>
                    </div>
                </nav>
            </div>
        )
